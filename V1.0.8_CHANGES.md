# ✅ Version 1.0.8 - Model Selection & Enhanced Prompt Engineering

## 🎉 Key Features

### 1. Model Selection UI
- **Dropdown selector** in chat drawer with 4 options:
  - 🤖 **Auto (Best Available)**: Automatically selects best model with offline-first priority
  - 📱 **Nano (Offline)**: Gemini Nano for Android 14+ devices
  - ☁️ **ChatGPT 4o mini**: Cloud-based model (requires API key)
  - 🦙 **Llama Small (Offline)**: Local model for Android 7+ devices

### 2. Enhanced Prompt Engineering
- **Structured visit context** with detailed formatting:
  - 📍 GPS Location: Latitude, longitude, accuracy
  - 📝 Current Note: Full text of user notes
  - 📷 Photo Available: Indicates presence and format
  - 🎤 Audio Recording: Indicates presence and format
  - 🌾 Latest Saved Visit: Complete record with all fields
...
- ✅ Auto mode still prioritizes: Nano → Llama → Cloud API
- ✅ Explicit model selection allows forcing specific models
- ✅ All models receive enhanced structured context
- ✅ Online/offline interaction preserved from v1.0.7
...
🎤 Audio Recording Available: Yes/No
